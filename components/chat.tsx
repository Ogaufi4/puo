...
import { ChatBubble, TranslationInputBar, PuoHeader, BottomIconBar } from './puo';
...
export function Chat({
  ...
  const handleSendMessage = (text: string) => {
    ...
    if (text.trim() && !isLoading) {
      ...
      console.log('🔵 [Chat] Message appended, switched to chat mode');
    } else {
      console.log('🔴 [Chat] Message not sent - empty or loading:', { isEmpty: !text.trim(), isLoading });
    }
  };
